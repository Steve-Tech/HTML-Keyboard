...
lmc_assign_keyboard('Macro Keyboard');

sendToAHK = function (key)
      print('It was assigned string:    ' .. key)
      local file = io.open("D:\\HTMLkeypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
...
lmc_set_handler('Macro Keyboard', function(button, direction)
